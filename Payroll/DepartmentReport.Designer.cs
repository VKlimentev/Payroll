namespace Payroll
{
    partial class DepartmentReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif([PaymentCategory] == \'Начисление\', \'Начислено\t\', \'Удержано\t\') + sumSum(Iif([P" +
                    "aymentCategory] == \'Начисление\', [Amount], -[Amount]))")});
